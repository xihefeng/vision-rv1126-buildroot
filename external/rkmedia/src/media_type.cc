...
static const struct CodecTypeEntry {
  ...
  const char *fmt_str;
    ...
    {CODEC_TYPE_MP3, AUDIO_MP3},     {CODEC_TYPE_MP2, AUDIO_MP2},
    {CODEC_TYPE_G711A, AUDIO_G711A}, {CODEC_TYPE_G711U, AUDIO_G711U},
    {CODEC_TYPE_G726, AUDIO_G726},   {CODEC_TYPE_H264, VIDEO_H264},
    {CODEC_TYPE_H265, VIDEO_H265},   {CODEC_TYPE_JPEG, VIDEO_MJPEG},
