...
#ifndef LOG_TAG
#define LOG_TAG "netserver"
#endif // LOG_TAG

#define LOG_INFO(format, ...)                                                  \
  do {                                                                         \
    if (netserver_log_level < LOG_LEVEL_INFO)                                   \
      break;                                                                   \
    if (enable_minilog)                                                        \
...
#define LOG_WARN(format, ...)                                                  \
  do {                                                                         \
    if (netserver_log_level < LOG_LEVEL_WARN)                                   \
      break;                                                                   \
    if (enable_minilog)                                                        \
...
#define LOG_ERROR(format, ...)                                                 \
  do {                                                                         \
    if (netserver_log_level < LOG_LEVEL_ERROR)                                  \
      break;                                                                   \
    if (enable_minilog)                                                        \
...
#define LOG_DEBUG(format, ...)                                                 \
  do {                                                                         \
    if (netserver_log_level < LOG_LEVEL_DEBUG)                                  \
      break;                                                                   \
    if (enable_minilog)                                                        \
