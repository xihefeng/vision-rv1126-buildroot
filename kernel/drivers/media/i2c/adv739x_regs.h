...
/* Registers for ADV7390 only, Table 79. 8-Bit NTSC Square Pixel YCrCb In (EAV/SAV),
CVBS/Y-C Out */
#define ADV7390_SD_MODE_REG1_DEFAULT		(0x10)
#define ADV7390_SD_MODE_REG2_DEFAULT		(0xcb)
#define ADV7390_SD_MODE_REG6_DEFAULT		(0x20)
#define ADV7390_SD_TIMING_REG0_DEFAULT		(0x0C)
#define ADV7390_SD_MODE_REG7_DEFAULT		(0x00)
