...
define VISION_SERVICES_INSTALL_BUILD_HOOKS
	$(INSTALL) -D -m  644 $(@D)/assets/build_datestamp "${BR2_PACKAGE_RK_OEM_INSTALL_TARGET_DIR}/etc/vision/build_datestamp" 
endef
