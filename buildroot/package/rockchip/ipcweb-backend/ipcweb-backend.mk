...
ifeq ($(BR2_PACKAGE_IPCWEB_BACKEND_XHLPR), y)
USE_NG_PATH="www-xhlpr"
else
USE_NG_PATH="www"
endif
...
define IPCWEB_BACKEND_INSTALL_TARGET_CMDS
	...
	cp -rfp $(@D)/$(USE_NG_PATH) $(IPCWEB_BACKEND_TARGET_INSTALL_DIR)/www
...
define IPCWEB_BACKEND_INSTALL_TARGET_CMDS
	...
	cp -rfp $(@D)/$(USE_NG_PATH) $(TARGET_DIR)/usr/www
