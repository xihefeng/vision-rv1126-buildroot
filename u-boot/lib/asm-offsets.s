...
@ -I ./arch/arm/mach-rockchip/include -imultilib .
@ -imultiarch arm-linux-gnueabihf
@ -iprefix /media/ssd/FireFly-RV1126JD4/rv1126_rv1109_linux_release_20211022/prebuilts/gcc/linux-x86/arm/gcc-linaro-6.3.1-2017.05-x86_64_arm-linux-gnueabihf/bin/../lib/gcc/arm-linux-gnueabihf/6.3.1/
@ -isysroot /media/ssd/FireFly-RV1126JD4/rv1126_rv1109_linux_release_20211022/prebuilts/gcc/linux-x86/arm/gcc-linaro-6.3.1-2017.05-x86_64_arm-linux-gnueabihf/bin/../arm-linux-gnueabihf/libc
@ -D __KERNEL__ -D __UBOOT__ -D __ARM__ -D __LINUX_ARM_ARCH__=7
@ -D DO_DEPS_ONLY -D KBUILD_STR(s)=#s
@ -D KBUILD_BASENAME=KBUILD_STR(asm_offsets)
@ -D KBUILD_MODNAME=KBUILD_STR(asm_offsets)
@ -isystem /media/ssd/FireFly-RV1126JD4/rv1126_rv1109_linux_release_20211022/prebuilts/gcc/linux-x86/arm/gcc-linaro-6.3.1-2017.05-x86_64_arm-linux-gnueabihf/bin/../lib/gcc/arm-linux-gnueabihf/6.3.1/include
...
@ -mfloat-abi=soft -march=armv7-a -mtune=cortex-a9 -mfpu=vfpv3-d16
@ -mtls-dialect=gnu -auxbase-strip lib/asm-offsets.s -g -Os -Wall
...
@ -fno-pic -funwind-tables -ffunction-sections -fdata-sections -fno-common
...
@ -msched-prolog -mthumb -mvectorize-with-neon-quad -mword-relocations
...
.ascii "->PM_CTX_PHYS #216 offsetof(struct global_data, pm_ctx_phys)"	@
@ 0 "" 2
	.loc 1 44 0
@ 44 "lib/asm-offsets.c" 1
	
.ascii "->GD_NEW_GD #68 offsetof(struct global_data, new_gd)"	@
@ 0 "" 2
	.loc 1 47 0
	.thumb
	.syntax unified
...
.LASF134:
	.ascii	"verify\000"
.LASF181:
	.ascii	"/media/ssd/FireFly-RV1126JD4/rv1126_rv1109_linux_re"
	.ascii	"lease_20211022/u-boot\000"
.LASF25:
...
.LASF179:
	...
	.ascii	"ccess -mabi=aapcs-linux -mfloat-abi=soft -march=arm"
	.ascii	"v7-a -mtune=cortex-a9 -mfpu=vfpv3-d16 -mtls-dialect"
	.ascii	"=gnu -g -Os -fno-builtin -ffreestanding -fshort-wch"
	.ascii	"ar -fno-stack-protector -fno-delete-null-pointer-ch"
	.ascii	"ecks -fstack-usage -fno-pic -funwind-tables -ffunct"
